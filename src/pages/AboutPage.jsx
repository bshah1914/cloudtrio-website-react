    ...
    <div>
          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-8">
            <StaggerItem>
              <motion.div whileHover={{ y: -4 }} className="card-glow p-10 h-full">
                <div className="pill pill-cyan text-xs mb-4">OUR MISSION</div>
            ...
            <StaggerItem>
              <motion.div whileHover={{ y: -4 }} className="card-glow p-10 h-full">
                <div className="pill pill-green text-xs mb-4">OUR VISION</div>
      ...
      <section className="bg-cta py-16 lg:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: 'var(--text-primary)' }}>Let&apos;s build something great</h2>
